		...
		<div class="form">
			<form:form action="add-transaction" method="post"
				...
				<form:select value="category" path="category.categoryName"
					class="forminput">
					<c:forEach items="${listIncomeCategory}" var="incomeCategory">
						<option>${incomeCategory.categoryName}</option>
					</c:forEach>
				</form:select>
				<br>
				<label>Description</label>
				<form:input type="text" path="description"
					placeholder="Enter a description of your income" class="forminput" />
				...
				<br>
				<input type="submit" value="ADD INCOME" id="button">
			</form:form>
		</div>
